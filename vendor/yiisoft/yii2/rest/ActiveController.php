...
class ActiveController extends Controller
{
    ...
    {
        return [
            'index' => ['GET', 'HEAD', 'POST'], //добавлен post
            'view' => ['GET', 'HEAD'],
            //'create' => ['POST'], //Voronka-по умолчанию при POST данных создается объект, но мне нужно передавать в пост параметры для получения объекта. создавать только через отдельную обработку
